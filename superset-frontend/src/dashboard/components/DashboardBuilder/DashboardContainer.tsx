...
import DashboardMobileGrid from 'src/dashboard/containers/DashboardMobileGrid';
import {
  ChartsState,
  DashboardInfo,
  DashboardLayout,
...
const DashboardContainer: FC<DashboardContainerProps> = ({ topLevelTabs }) => {
  ...
  const [initKeys,setInitKeys] = useState(DASHBOARD_GRID_ID)
      ...
      <ParentSize>
        {({ width }) => (
          ...
          */
          ...
          //   activeKey={initKeys} 
          //   onTabClick={(ksys,e)=>{
          //     console.log("onTabClick事件",ksys,e);
              
          //     setInitKeys(ksys)
          //   }}
          //   onClick={(e)=>{
          //     console.log("onClick事件",e);
          //   }}
          //   onChange={(e)=>{
          //     console.log("onChange事件",e);
          //   }}
          // >
          //   {
          //     childIds.map((id, index)=>{
          //       return(
          //         <Tabs.TabPane tab={index===0?"PC端":"移动端"} key={id}>
          //           {
          //             index === 0?(
          //               <DashboardGrid
          ...
          <Tabs
            ...
            defaultActiveKey={DASHBOARD_GRID_ID}
            renderTabBar={() => <></>}
            fullWidth={false}
            animated={false}
            allowOverflow
