 ...
 * under the License.
 */
import { SupersetUiPluginChatCustomEchartsTest } from '../src';
 ...
 */
describe('@superset-ui/plugin-chat-custom-echarts-test', () => {
  it('exists', () => {
    expect(SupersetUiPluginChatCustomEchartsTest).toBeDefined();
  });
});
